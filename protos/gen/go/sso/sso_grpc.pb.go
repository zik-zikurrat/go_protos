...
const (
	...
	Auth_IsDemo_FullMethodName   = "/auth.Auth/IsDemo"
)
...
type AuthClient interface {
	...
	IsDemo(ctx context.Context, in *IsDemoRequest, opts ...grpc.CallOption) (*IsDemoResponse, error)
}
...
func (c *authClient) IsDemo(ctx context.Context, in *IsDemoRequest, opts ...grpc.CallOption) (*IsDemoResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(IsDemoResponse)
	err := c.cc.Invoke(ctx, Auth_IsDemo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServer interface {
	...
	IsDemo(context.Context, *IsDemoRequest) (*IsDemoResponse, error)
...
func (UnimplementedAuthServer) IsDemo(context.Context, *IsDemoRequest) (*IsDemoResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method IsDemo not implemented")
}
...
func _Auth_IsDemo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(IsDemoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServer).IsDemo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Auth_IsDemo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).IsDemo(ctx, req.(*IsDemoRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
const (
	ServiceRegistry_RegisterService_FullMethodName = "/auth.ServiceRegistry/RegisterService"
)
...
var ServiceRegistry_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "auth.ServiceRegistry",
