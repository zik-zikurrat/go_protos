...
const file_sso_sso_proto_rawDesc = "" +
	"\n" +
	"\rsso/sso.proto\x12\x06sso.v1\"Y\n" +
	...
	"\x0fRegisterService\x12\x1e.sso.v1.RegisterServiceRequest\x1a\x1f.sso.v1.RegisterServiceResponseB\x83\x01\n" +
	"\n" +
	"com.sso.v1B\bSsoProtoP\x01Z2github.com/zik-zikurrat/go_protos/gen/go/sso;ssov1\xa2\x02\x03SXX\xaa\x02\x06Sso.V1\xca\x02\x06Sso\\V1\xe2\x02\x12Sso\\V1\\GPBMetadata\xea\x02\aSso::V1b\x06proto3"
